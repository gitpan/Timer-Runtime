# This Makefile is for the Timer::Runtime extension to perl.
#
...
#     AUTHOR => q[Adam H Wohld, C<< <adam at jamradar.com> >>, Adam H Wohld <adam@jamradar.com>]
#     BUILD_REQUIRES => {  }
#     DISTNAME => q[Timer-Runtime]
#     LICENSE => q[perl]
#     NAME => q[Timer::Runtime]
#     NO_META => q[1]
#     PREREQ_PM => { Time::Elapse=>q[0], Test::More=>q[0], ExtUtils::MakeMaker=>q[6.42], Time::Local=>q[0], Cwd=>q[0] }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/Timer/Runtime.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Timer/Runtime.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Timer
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Timer
...
TO_INST_PM = lib/Timer/Runtime.pm

PM_TO_BLIB = lib/Timer/Runtime.pm \
	blib/lib/Timer/Runtime.pm
...
DISTNAME = Timer-Runtime
DISTVNAME = Timer-Runtime-0.01
...
manifypods : pure_all  \
	lib/Timer/Runtime.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Timer/Runtime.pm $(INST_MAN3DIR)/Timer::Runtime.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Adam H Wohld, C&lt;&lt; &lt;adam at jamradar.com&gt; &gt;&gt;, Adam H Wohld &lt;adam@jamradar.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Time::Elapse" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Timer/Runtime.pm blib/lib/Timer/Runtime.pm 
